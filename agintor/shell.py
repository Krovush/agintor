...
class AgentPool:
    ...
    def _install_defaults(self) -> None:
        defaults = [
            ...
            AgentTemplate(agent_id="researcher", description="Deep research orchestrator for multi-source question answering", capability_set=["plan", "decompose", "merge", "synthesize"], symbol_set=["research", "sources", "citations"], default_tool_scope=[], success_stats={"e2e": 0.7, "global": 0.6}, staleness_clock=0, model_policy_tag="large"),
            AgentTemplate(agent_id="searcher", description="Search subagent for web and corpus evidence gathering", capability_set=["search", "retrieve", "summarize"], symbol_set=["query", "source", "web"], default_tool_scope=[], success_stats={"top": 0.65, "e2e": 0.6}, staleness_clock=0, model_policy_tag="medium"),
            AgentTemplate(agent_id="reader", description="Reader that distills long sources into implementation findings", capability_set=["read", "summarize", "evidence"], symbol_set=["document", "pdf", "site"], default_tool_scope=[], success_stats={"mem": 0.65, "e2e": 0.6}, staleness_clock=0, model_policy_tag="medium"),
            AgentTemplate(agent_id="synthesizer", description="Answer synthesizer that compiles cited final reports", capability_set=["synthesize", "write", "cite"], symbol_set=["answer", "citation"], default_tool_scope=[], success_stats={"e2e": 0.75, "global": 0.65}, staleness_clock=0, model_policy_tag="large"),
