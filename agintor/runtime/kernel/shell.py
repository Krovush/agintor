...
class FixedShell:
    def __init__(
        self,
        workspace: Path,
        predictors: RuntimePredictorState | None = None,
        *,
        ...
        self.predictors = predictors or RuntimePredictorState()
    ...
    def reset_for_task(self, task_id: str = "", transfer_scored: bool = False, episode_id: str | None = None) -> None:
        ...
        if not self._shared_predictors:
            self.predictors = RuntimePredictorState()
    ...
    def fork_branch(self, branch_id: str) -> "FixedShell":
        ...
        branch_shell.predictors = RuntimePredictorState.fork_from_snapshot(predictor_snapshot)
