...
from .projections import assert_no_sealed_material, public_package_view
...
class OracleQARunner:
    ...
    def _schema_check(package: OraclePackage) -> QACheck:
        try:
            OraclePackage.model_validate(package.model_dump(mode="json", exclude_none=True))
    ...
    def _leakage_projection_check(package: OraclePackage) -> QACheck:
        try:
            assert_no_sealed_material(public_package_view(package), package.leakage_policy.sealed_fields_forbidden)
